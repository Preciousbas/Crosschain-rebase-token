...
contract CrossChainTest is Test {
    ...
    function setUp() public {
        ...
        sourceRebaseToken.assignMintAndBurnRole(address(sourcePool));
        sourceRebaseToken.assignMintAndBurnRole(address(vault));
        ...
        destRebaseToken.assignMintAndBurnRole(address(destPool));
    ...
    function testBridgeTwice() public {
        ...
        console.log("Sepolia Chain Selector: ", sepoliaNetworkDetails.chainSelector);
        bridgeTokens(
            SEND_VALUE / 4,
            arbSepoliaFork,
            sepoliaFork,
